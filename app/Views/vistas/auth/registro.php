                    ...
                    <form action="<?= base_url('auth/registrarUsuario') ?>" method="POST">
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <div class="position-absolute end-0 me-3 d-flex align-items-center">
                                    ...
                                    <i class="fas fa-info-circle text-info" 
                                        ...
                                        data-bs-content="Mínimo 5 caracteres (según validación), una mayúscula y números."></i>
                                </div>
                            </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select id="tipo_user" class="form-control" name="tipo_user" required>
                                <option value="" disabled <?= old('tipo_user') ? '' : 'selected' ?>>Seleccione un tipo de usuario</option>
                                <option value="Profesor" <?= old('tipo_user') == 'Profesor' ? 'selected' : '' ?>>Profesor</option>
                                <option value="Estudiante" <?= old('tipo_user') == 'Estudiante' ? 'selected' : '' ?>>Estudiante</option>
                            </select>
                        </div>
